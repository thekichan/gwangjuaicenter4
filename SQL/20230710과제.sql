...
insert into c_student(name, score, attendance, major_id) values ('기 찬', 91, 96, 2);
insert into c_student(name, score, attendance, major_id) values ('김효정', 92, 97, 3);
insert into c_student(name, score, attendance, major_id) values ('박 겸', 93, 94, 4);
insert into c_student(name, score, attendance, major_id) values ('박성현', 94, 98, 5;
